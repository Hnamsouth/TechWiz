            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Create Player</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-horizontal card-default card-md mb-4">
                        ...
                        <div class="card-body py-md-30">
                            <div class="horizontal-form">
                                <form action="{{ route('player-create') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-25">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("number") is-invalid @enderror" name="number" id="inputCountry" value="{{ old('number') }}" >
                                            @error("number")
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group row mb-25">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("height") is-invalid @enderror" name="height" id="inputCountry" value="{{ old('height') }}">
                                            @error("height")
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group row mb-25">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("weight") is-invalid @enderror" name="weight" id="inputCountry" value="{{ old('weight') }}">
                                            @error("weight")
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
