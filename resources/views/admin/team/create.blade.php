                        ...
                        <div class="horizontal-form">
                            <form action="{{ route('team-create') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-25">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("country") is-invalid @enderror" name="country" id="inputCountry" placeholder="Enter country" >
                                        @error("country")
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
