            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Create team</h4>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="horizontal-form">
                            <form action="{{ route('team-create') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-25">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("country") is-invalid @enderror" name="country" id="inputCountry" placeholder="Enter country" value="{{ old('country') }}" >
                                        @error("country")
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-group row mb-25">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("continent") is-invalid @enderror" name="continent" id="inputCountry" placeholder="Enter continent" value="{{ old('continent') }}" >
                                        @error("continent")
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-group row mb-25">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" id="inputLevel">
                                            <option @if(old("level")== "0") selected @endif value="0" >Club</option>
                                            <option @if(old("level")== "1") selected @endif value="1">National</option>
                                        </select>
                                    </div>
                                </div>
