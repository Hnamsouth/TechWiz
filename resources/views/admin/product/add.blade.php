                                            ...
                                            <div class="add-product__body px-sm-40 px-20">
                                                ...
                                                <div class="form-group quantity-appearance">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="pt_Quantity">
                                                            <input name="price" type="number" class="form-control @error("price") is-invalid @enderror" min="0" step="1" value="0" data-inc="1" required>
                                                        </div>
                                                    </div>
                                                    @error("price")
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group quantity-appearance">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="pt_Quantity">
                                                            <input name="quantity" type="number" class="form-control @error("quantity") is-invalid @enderror" min="0" step="1" value="0" data-inc="1" required>
                                                        </div>
                                                    </div>
                                                    @error("quantity")
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="short_desc" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Enter short description"></textarea>
                                                </div>
...
<!--              </div>-->
                    ...
                    // // create new input element for the uploaded file
        ...
        //     evt.preventDefault();
        //     evt.currentTarget.closest(".upload-media-area").remove();
        // }
    </script>
