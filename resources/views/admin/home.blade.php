        ...
        <div class="row ">
            ...
            <div class="col-xxl-3 col-md-6 col-ssm-12 mb-30">
                ...
                <div class="ap-po-details p-25 radius-xl bg-white d-flex justify-content-between">
                    <div>
                        <div class="overview-content">
                            <h1>${{number_format($averageValue,2)}}</h1>
                            <p>Avg. Order Value</p>
                            <div class="ap-po-details-time">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="tl_revenue-week" role="tabpanel" aria-labelledby="tl_revenue-week-tab">
                                <div class="revenue-labels">
                                    <div>
                                        <strong class="text-primary">${{number_format(array_sum($revenueWeek),2)}}</strong>
                                        <span>Current Period</span>
                                    </div>
                                    <div>
                                        <strong>${{number_format(array_sum($previousRevenueWeek),2)}}</strong>
                            ...
                            <div class="tab-pane fade" id="tl_revenue-month" role="tabpanel" aria-labelledby="tl_revenue-month-tab">
                                <div class="revenue-labels">
                                    <div>
                                        <strong class="text-primary">${{number_format(array_sum($revenueMonth),2)}}</strong>
                                        <span>Current Period</span>
                                    </div>
                                    <div>
                                        <strong>${{number_format(array_sum($previousRevenueMonth),2)}}</strong>
                                        <span>Previous Period</span>
                                    </div>
                                </div>
                                <!-- ends: .performance-stats -->
                            ...
                            <div class="tab-pane fade active show" id="tl_revenue-year" role="tabpanel" aria-labelledby="tl_revenue-year-tab">
                                <div class="revenue-labels">
                                    <div>
                                        <strong class="text-primary">${{number_format(array_sum($revenueYear),2)}}</strong>
                                        <span>Current Period</span>
                                    </div>
                                    <div>
                                        <strong>${{number_format(array_sum($previousRevenueYear),2)}}</strong>
                                        <span>Previous Period</span>,
                                    </div>
                                </div>
                                <!-- ends: .performance-stats -->
