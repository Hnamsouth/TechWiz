            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Edit Coach</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-horizontal card-default card-md mb-4">
                        ...
                        <div class="card-body py-md-30">
                            <div class="horizontal-form">
                                <form action="{{ route('coach-edit',["coaches"=>$coaches->id]) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row mb-25">
                                        <div class="card-header">
                                            <h6 class="fw-500">ID: {{$coaches->id}}</h6>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-25">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15 @error("name") is-invalid @enderror" name="name" id="inputName" placeholder="Enter name" value="{{ $coaches->name }}" >
                                            @error("name")
                                    ...
                                    <div class="form-group row mb-25">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("nationality") is-invalid @enderror" name="nationality" id="inputCountry" placeholder="Enter nationality" value="{{ $coaches->nationality }}" >
                                            @error("nationality")
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group row mb-25">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("date_of_birth") is-invalid @enderror" name="date_of_birth" id="inputCountry" value="{{ $coaches->date_of_birth }}" >
                                            @error("date_of_birth")
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group row mb-25">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea rows="5" class="form-control  ih-medium ip-gray radius-xs b-light px-15 @error("description") is-invalid @enderror" name="description" id="inputCountry" placeholder="Description" value="{{ $coaches->description }}"></textarea>
                                            @error("description")
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="atbd-tag-wrap d-inline-block position-relative">
                                                <div class="atbd-upload">
                                                    ...
                                                    <div class="avatar-up">
                                                        <input type="file" name="image" class="upload-avatar-input" accept="image" value={{$coaches->image}}>
                                                    </div>
