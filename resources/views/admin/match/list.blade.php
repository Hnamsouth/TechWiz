        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main mb-3">
                    <h4 class="text-capitalize breadcrumb-title">Match</h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <div class="action-btn">
                            <a href="{{url("admin/match/create")}}" class="btn btn-sm btn-primary btn-add">
                                <i class="la la-plus"></i> Add New Match</a>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="userDatatable global-shadow border-0 bg-white w-100" id="table-hover">
                            <div class="table-responsive">
                                <table class="table mb-0 table-borderless">
                                    ...
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <div class="userDatatable-title">Location</div>
                                        </th>
                                        ...
                                        <th>
                                            <span class="userDatatable-title">First team</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">Second team</span>
                                        </th>
                                        <th>
                                    ...
                                    @foreach($data as $item)
                                                ...
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                    <li>
                                                        <a class="view detail-btn"
                                                           href="{{url("admin/match/detail",["match"=>$item->id])}}">
                                                            <span data-feather="eye"></span></a>
                                                    </li>

                                                    <li>
                                                        <a href="{{url("admin/match/edit",["match"=>$item->id])}}"
                                                           class="edit">
                                                            <span data-feather="edit"></span></a>
                                                    </li>
                                                    <li>
                                                        <form id="delete-form-{{ $item->id }}"
                                                              action="{{ url("admin/match/delete",["match"=>$item->id]) }}"
                                                              method="post" style="">
                                                            @method("DELETE")
                                                            @csrf
                                                            <button type="button" class="delete-button"
                                                                    ...
                                                                    data-toggle="modal"
                                                                    data-target="#modal-info-confirmed-{{ $item->id }}">
                                                                <a class="remove">
                                        ...
                                        <div class="modal-info-confirmed modal fade show"
                                             id="modal-info-confirmed-{{ $item->id }}" tabindex="-1" role="dialog"
                                             aria-hidden="true">
                            ...
                            <div class="d-flex justify-content-end mt-30 table5">
                                <div class="pagination-total-text">{{ $data->firstItem() }}-{{ $data->lastItem() }}
                                    of {{ $data->total() }} items
                                </div>
                                <nav class="atbd-page ">
