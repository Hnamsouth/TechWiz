                ...
                <div class="breadcrumb-main user-member justify-content-sm-between ">
                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                        <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                            ...
                            <span class="sub-title ml-sm-25 pl-sm-25">{{$employees->total()}} Employees</span>
                        </div>

                        <form action="{{ route('employee-list') }}" class="d-flex align-items-center user-member__form my-sm-0 my-2" method="get">
                    ...
                    <div class="action-btn">
                        <a href="{{url('admin2/employee/create')}}" class="btn px-15 btn-primary">
                            <i class="las la-plus fs-16"></i>Add New Employee</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                            <li>
                                                <a href="{{route('edit-employee',['employee'=>$employee->id])}}" class="edit">
                                                    <span data-feather="edit"></span></a>
                                            </li>
                                            <li>
                                                <form id="delete-form-{{ $employee->id }}" action="{{ route("delete-employee",["employee"=>$employee->id]) }}" method="post" style="">
                                                    @method("DELETE")
                                                    @csrf
                                    ...
                                    <div class="modal-dialog modal-sm modal-info" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="modal-info-body d-flex">
                                                    ...
                                                    <div class="modal-info-text">
                                                        <h6>Do you Want to delete employee #{{$employee->id}}?</h6>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-info btn-sm" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $employee->id }}').submit();">Ok</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
