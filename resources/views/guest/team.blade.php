            ...
            <div class="row">
                <div class="tg-banner-content tg-haslayout">
                    <div class="tg-pagetitle">
                        <h1>players Version 2</h1>
                    </div>
                    <ol class="tg-breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li class="active">players Version 2</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <figure class="tg-postimg">
                                            <img src="assets/images/player/img-01.jpg" alt="image description">
                                    ...
                                    <div class="swiper-slide">
                                        <figure class="tg-postimg">
                                            <img src="assets/images/player/img-02.jpg" alt="image description">
                                            <figcaption class="tg-img-hover">
                                                <a href="#" class="tg-theme-tag">SWEEPER</a>
                                                <div class="tg-section-heading">
                                                    <h3><a href="#">Hustlin’ Owls</a></h3>
                                    ...
                                    <div class="swiper-slide">
                                        <figure class="tg-postimg">
                                            <img src="assets/images/player/img-03.jpg" alt="image description">
                                            <figcaption class="tg-img-hover">
                                                <a href="#" class="tg-theme-tag">SWEEPER</a>
                                                <div class="tg-section-heading">
                                                    <h3><a href="#">Hustlin’ Owls</a></h3>
                ...
                <div class="row">
                    <div id="tg-testimonial-slider" class="tg-testimonial-slider tg-haslayout">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <figure>
                                    <img src="assets/images/trophy.png" alt="image description">
                                </figure>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tg-match">
                                                    <div class="tg-matchdetail">
                                                        <div class="tg-box">
                                                            <strong class="tg-teamlogo">
                                                                <img src="assets/images/sponser/img-02.png" alt="image description">
                                                            </strong>
                                                        </div>
                                                        <div class="tg-box">
                                                            <span>sponsored in 2016</span>
